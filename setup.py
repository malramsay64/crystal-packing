...
setup(
    name='pypacking',
    version='0.1.0',
    description="Finding the best packings of shapes in an infinite space.",
    long_description=readme + '\n\n' + history,
    author="Malcolm Ramsay",
    author_email='malramsay64@gmail.com',
    url='https://github.com/malramsay64/pypacking',
    packages=[
        'pypacking',
    ],
    package_dir={'pypacking':
                 'pypacking'},
    entry_points={
        'console_scripts': [
            'pypacking=pypacking.cli:main'
        ]
    },
    ...
    zip_safe=False,
    rust_extensions=[
        RustExtension('pypacking', 'pypacking/rust/Cargo.toml',
